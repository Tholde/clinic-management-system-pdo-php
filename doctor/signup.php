    ...
    <div class="wrapper" style="background-image: url('images/concentrated.jpg');">
        <div class="inner">
            ...
            <form method="post" action="include/signup.php" enctype="multipart/form-data">
                ...
                <div class="form-wrapper">
                    <input type="text" name="nom" placeholder="First Name" class="form-control" value="<?php echo $_POST["nom"]; ?>" required>
                    <i class="zmdi zmdi-account"></i>
                </div>
                <div class="form-wrapper">
                    <input type="text" name="prenom" placeholder="Last Name" class="form-control" value="<?php echo $_POST["prenom"]; ?>">
                    <i class="zmdi zmdi-account"></i>
                </div>
                <div class="form-wrapper">
                    <input type="number" name="phone" placeholder="Phone Number" class="form-control" value="<?php echo $_POST["phone"]; ?>" required>
                ...
                <div class="form-wrapper">
                    <select name="role" id="" class="form-control" required>
                        <option value="<?php echo $_POST["role"]; ?>" disabled selected>Role</option>
                        <option value="0">Medecin</option>
                        <option value="1">Infirmière</option>
                    </select>
