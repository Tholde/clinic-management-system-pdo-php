<?php
	...
	if (isset($_POST['submit'])) {
		...
		if (!$permited) {
			...
			$action->connect();
			$action->updateDr($doc);
			echo "<script>alert('update succesfuly!');document.location='manage-doctors.php'</script>";
		}
	}
	$action->connect();
										...
										<div class="col-lg-8 col-md-12">
											<div class="panel panel-white">
												...
												<div class="panel-body">
													...
													<hr />
													<form role="form" method="post"  enctype="multipart/form-data" onSubmit="return valid();">
													<div class="form-group">
															<label for="doctorname">
																 Doctor Image Profil
															</label>
															<input type="file" name="image" class="form-control" value=""  required="true">
														</div>		
													<div class="form-group">
