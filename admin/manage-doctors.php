										...
										<?php else : ?>
											...
											?>
												<tr>
													...
													<td class="hidden-xs"><?= $val['firstname'] ?> <?= $val['lastname'] ?></td>
													<td><?php echo date('d/m/Y à H:i', strtotime($val['last_update'])); ?></td>
													<td>
														<div class="visible-md visible-lg hidden-sm hidden-xs">
															<a href="edit-doctor.php?id=<?= $val['id'] ?>" class="btn btn-transparent btn-xs" tooltip-placement="top" tooltip="Edit"><i class="fa fa-pencil"></i></a>

															<a href="delete-doctor.php?del=<?= $val['id'] ?>" onClick="return confirm('Are you sure you want to delete?')" class="btn btn-transparent btn-xs tooltips" tooltip-placement="top" tooltip="Remove"><i class="fa fa-times fa fa-white"></i></a>
														</div>
