<?php
	...
	$spec->id = $_GET['id'];
		...
		$action->connect();
		$action->updateSpecialization($spec);
		echo "<script>alert('Data updated successfully!');document.location='doctor-specilization.php'</script>";
	}
	$action->connect();
	$one = $action->fetchOneSpecialization($_GET['id']);
?>
<!DOCTYPE html>
<html lang="en">
	<head>
								...
								<p style="color:red;"></p>	
													<form role="form" name="dcotorspcl" method="post" >
														<div class="form-group">
															...
															<input type="text" name="doctorspecilization" class="form-control" value="<?= $value['name'] ?>" >
															<?php endforeach; ?>
														</div>
