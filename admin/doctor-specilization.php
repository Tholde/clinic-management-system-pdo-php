...
if (isset($_POST['submit'])) {
	$spec->name = $_POST['doctorspecilization'];
	$action->connect();
	$action->insertSpecialization($spec);
}
$action->connect();
$all = $action->fetchAllSpecialization();
?>
<!DOCTYPE html>
<html lang="en">
												...
												<tr>
													...
													<td>
														<div class="visible-md visible-lg hidden-sm hidden-xs">
															<a href="edit-doctor-specialization.php?id=<?= $val['id'] ?>" class="btn btn-transparent btn-xs" tooltip-placement="top" tooltip="Edit"><i class="fa fa-pencil"></i></a>
															<?php  ?>
															<a href="delete-specialisation.php?id=<?= $val['id'] ?>&del=delete" onClick="return confirm('Are you sure you want to delete?')" class="btn btn-transparent btn-xs tooltips" tooltip-placement="top" tooltip="Remove"><i class="fa fa-times fa fa-white"></i></a>
														</div>
