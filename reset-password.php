...
if (empty($_GET['id'])) {
	...
	if (isset($_POST['submit'])) {
		...
		if ($_POST['newPassword'] === $_POST['confirmPassword']) {
			...
			$action->connect();
			$action->resetPassPatient($ab);
			header("location:user-login.php?id=" . $_GET['id'] . "");
			//echo "<script>alert('Updated successfully!');document.location='user-login.php?id=".$_GET['id']."</script>";
		} else
