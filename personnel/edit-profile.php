...
<head>
	<title>Doctr | Edit Personal Details</title>
			...
			<div class="main-content">
				<div class="wrap-content container" id="container">
					...
					<section id="page-title">
						<div class="row">
							<div class="col-sm-8">
								<h1 class="mainTitle">Personal | Edit Personal Details</h1>
							</div>
							<ol class="breadcrumb">
								<li>
									<span>Personal</span>
									...
									<div class="col-lg-8 col-md-12">
										<div class="panel panel-white">
											<div class="panel-heading">
												<h5 class="panel-title">Edit Personal</h5>
											</div>
											<?php foreach ($oneDr as $key => $value) : ?>
												<div class="panel-body">
													<h4><?= $value['fullname'] ?>'s Profile</h4>
														...
														<div class="form-group">
															<label for="DoctorSpecialization">
																Personal Department
																	...
																	$action->connect();
																	$oneSpc = $action->fetchOneDepartmentName($value['department']);
																	?>
