...
$ab = new Personal();
$action->connect();
$listadmin = $action->fetchOnePersonnal($_GET['id']);
foreach ($listadmin as $key => $value) {
	if (isset($_POST['submit'])) {
		if (md5($_POST['lastPassword']) === $value['password']) {
			if ($_POST['newPassword'] === $_POST['confirmPassword']) {
				$ab->id = $value['id'];
				$ab->password = md5($_POST['newPassword']);
				$action->connect();
				$action->updatePassPers($ab);
			...
			<div class="main-content">
				<div class="wrap-content container" id="container">
					...
					<section id="page-title">
						<div class="row">
							<div class="col-sm-8">
								<h1 class="mainTitle">Personal | Change Password</h1>
							</div>
							<ol class="breadcrumb">
								<li>
									<span>Personal</span>
											...
											<div class="panel-body">
												...
												<form role="form" name="chngpwd" method="post" onSubmit="return valid();">
													<div class="form-group">
														...
														<input type="password" name="lastPassword" class="form-control" placeholder="Enter Current Password">
													</div>
													<div class="form-group">
